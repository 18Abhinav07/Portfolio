...
import { Experiences } from "./components/experience/experienceValues";
  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-4 md:p-8 lg:p-15 xl:p-35 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-3/4 lg:pr-0 xl:w-1/2 items-center">
          {/* BIOGRAPHY CONTAINER */}
